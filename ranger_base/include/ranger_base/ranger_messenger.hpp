...
#include "interfaces/msg/ranger_status.hpp"
#include "interfaces/msg/ranger_setting.hpp"
...
class RangerMessenger {
 public:
  ...
  void SetupSubscription() {
    ...
    status_pub_ = node_->create_publisher<interfaces::msg::RangerStatus>(
        "/ranger_status", 10);
  ...
  void PublishStateToROS() {
    ...
    interfaces::msg::RangerStatus status_msg;
  ...
  // x , y direction linear velocity, motion radius
    ...
    switch (motion_mode_) 
    {
      case interfaces::msg::RangerSetting::MOTION_MODE_ACKERMAN: {
      ...
      case interfaces::msg::RangerSetting::MOTION_MODE_SLIDE: {
      ...
      case interfaces::msg::RangerSetting::MOTION_MODE_ROUND: {
      ...
      case interfaces::msg::RangerSetting::MOTION_MODE_SLOPING: {
  ...
  void RangerSettingCbk(const interfaces::msg::RangerSetting::SharedPtr msg) {
    auto mode = msg->motion_mode;
    motion_mode_ = mode;
    switch (mode) {
      case interfaces::msg::RangerSetting::MOTION_MODE_ACKERMAN:{
        ranger_->SetMotionMode(interfaces::msg::RangerSetting::MOTION_MODE_ACKERMAN);
        break;
      }
      case interfaces::msg::RangerSetting::MOTION_MODE_SLIDE:{
        ranger_->SetMotionMode(interfaces::msg::RangerSetting::MOTION_MODE_SLIDE);
        break;
      }
      case interfaces::msg::RangerSetting::MOTION_MODE_ROUND:{
        ranger_->SetMotionMode(interfaces::msg::RangerSetting::MOTION_MODE_ROUND);
        break;
      }
      case interfaces::msg::RangerSetting::MOTION_MODE_SLOPING:{
        ranger_->SetMotionMode(interfaces::msg::RangerSetting::MOTION_MODE_SLOPING);
        break;
      }
      default:
 ...
 private:
  ...
  void PublishOdometryToROS(double linear, double angle_vel,
    ...
    d_x = cos(theta_) * x_linear_vel_ * dt - sin(theta_) * y_linear_vel_ * dt;
    d_y = sin(theta_) * x_linear_vel_ * dt + cos(theta_) * y_linear_vel_ * dt;
    ...
    covar_pose_twist    += 0.01 * std::fabs(theta);
    covar_twist_linear  = 0.1 * std::sqrt(x_linear_vel*x_linear_vel + y_linear_vel*y_linear_vel);
    covar_twist_angular = 0.1 * std::fabs(angle_vel);
